...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom { // ItemRepositoryCustom 상속
    ...
    //상품 상태 조건이 전체(null)일 경우는 null을 리턴합니다. 결과값이 null이면 where절에서 해당 조건은 무시됩니다.
    ...
    private BooleanExpression searchSellStatusEq(ItemSellStatus searchSellStatus) {
        ...
        // 조회합니다. 예를 들어 sarchDateType 값이 "1m"인 경우 dateTime의 시간을 한 달 전으로 세팅 후 최근 한 달 동안 등록된 상품만 조회하도록 조건값을 반환합니다.
    ...
    public Page<Item> getAdminItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        // 이제 queryFactory를 이용해서 쿼리를 생성합니다. 쿼리문을 직접 작성할 때의 형태와 문법이 비슷한 것을 볼 수 있습니다.
        /*
            - selectForm(QItem.item) : 상품 데이터를 조회하기 위해서 QItem의 item을 지정합니다.
            ...
            - fetchResult() : 조회한 리스트 및 전체 개수를 포함하는 QueryResults를 반환합니다. 상품 데이터 리스트 조회 및 상품 데이터 전체 개수를 조회하는 2번의 쿼리문이 실행  
         */

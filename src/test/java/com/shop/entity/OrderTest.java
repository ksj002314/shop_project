...
class OrderTest {
    ...
    public void cascadeTest() {
        ...
        for(int i=0; i<3; i++) {
            ...
            order.getOrderItems().add(orderItem);   // 영속성 컨텍스트에 저장되지 않은 orderItem 엔티티를 order 엔티티에 담아줍니다.
        }
    ...
    public void lazyLoadingTest() {
        ...
        OrderItem orderItem = orderItemRepository.findById(orderItemId)     // 영속성 컨텍스트의 상태 초기화 후 order 엔티티에 저장했던 주문 상품 아이디를 이용하여 orderItem을 DB에서 다시 조회합니다.
                .orElseThrow(EntityNotFoundException::new);
